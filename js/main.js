document.addEventListener('DOMContentLoaded', function() {
    ...
    fetch(`${groupURL}`)
      ...
      <div class="card" id=group-${group.id}>
        ...
        <button class="btn btn-outline-warning" data-id=${group.id} id="edit-${group.id}" data-action="edit">Edit</button>
        <button class="btn btn-outline-danger" data-id=${group.id} id="delete-${group.id}" data-action="delete">Delete</button>
      </div>
    ...
    groupContainer.addEventListener('click', (e) => {
        if (e.target.dataset.action === 'edit') {
            const updating = confirm('really nigga?');
            if (updating) {
